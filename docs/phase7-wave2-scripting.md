...
- `fear-of-kang-constant.test.ts` was rewritten, not deleted: it keeps its original regression guard (a *bare*,
...
- `11020.depowered-constant`'s `cards` filter narrowed from the `eachPlayer` workaround to `identitySetOf: you` —
  ...
  more literal reading of "you cannot play *your* hero-specific cards". `kang-encounter-set.ts`'s module docblock
