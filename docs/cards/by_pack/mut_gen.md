...
| `32001b` | Piotr Rasputin | Alter-Ego | Colossus | HP:14 | - | `mut_gen` |
...
| `32025` | Homesick | Obligation | Colossus | - | 2 pips | `mut_gen` |
| `32026` | Juggernaut | Minion | Colossus Nemesis | SCH:1 ATK:4 HP:8 | 2 pips | `mut_gen` |
| `32027` | Rampaging Juggernaut | Side Scheme | Colossus Nemesis | - | 3 pips | `mut_gen` |
| `32028` | Unstoppable | Attachment | Colossus Nemesis | ATK:2 | 2 pips | `mut_gen` |
| `32029` | Slammed | Treachery | Colossus Nemesis | - | 2 pips | `mut_gen` |
| `32030a` | Shadowcat | Hero | Shadowcat | THW:2 ATK:2 DEF:2 HP:9 | - | `mut_gen` |
| `32030b` | Kitty Pryde | Alter-Ego | Shadowcat | HP:9 | - | `mut_gen` |
...
| `32055` | Permanently Phased | Obligation | Shadowcat | - | 2 pips | `mut_gen` |
| `32056` | White Queen | Minion | Shadowcat Nemesis | SCH:1 ATK:1 HP:5 | 1 pips | `mut_gen` |
| `32057` | The Hellfire Club | Side Scheme | Shadowcat Nemesis | - | 3 pips | `mut_gen` |
| `32058` | Hellfire Pawn | Minion | Shadowcat Nemesis | SCH:1 ATK:2 HP:3 | Star | `mut_gen` |
| `32059` | Telepathic Restraint | Attachment | Shadowcat Nemesis | - | 2 pips | `mut_gen` |
...
| `32065a` | Find the Senator | Side Scheme | Sabretooth | - | - | `mut_gen` |
| `32065b` | Protect the Senator | Environment | Sabretooth | - | - | `mut_gen` |
| `32066` | Robert Kelly | Ally | Sabretooth | HP:9 | - | `mut_gen` |
| `32067` | Adamantium Claws | Attachment | Sabretooth | ATK:1 | Star | `mut_gen` |
| `32068` | Animal Ferocity | Attachment | Sabretooth | - | Star | `mut_gen` |
| `32069` | Sabretooth Strikes | Treachery | Sabretooth | - | Star | `mut_gen` |
| `32070` | Unrelenting Savage | Treachery | Sabretooth | - | 1 pips | `mut_gen` |
| `32071` | Medical Emergency | Side Scheme | Sabretooth | - | 2 pips | `mut_gen` |
| `32072` | Feral Rage | Side Scheme | Sabretooth | - | 3 pips | `mut_gen` |
| `32073` | Avalanche | Minion | Brotherhood | SCH:1 ATK:3 HP:5 | 1 pips | `mut_gen` |
| `32074` | Blob | Minion | Brotherhood | SCH:1 ATK:2 HP:6 | 2 pips | `mut_gen` |
| `32075` | Pyro | Minion | Brotherhood | SCH:2 ATK:0 HP:4 | 2 pips | `mut_gen` |
| `32076` | Toad | Minion | Brotherhood | SCH:2 ATK:2 HP:3 | 1 pips | `mut_gen` |
| `32077` | Homo Superior | Attachment | Brotherhood | - | 1 pips | `mut_gen` |
| `32078` | Mutant Terrorists | Treachery | Brotherhood | - | 2 pips | `mut_gen` |
| `32079` | The Brotherhood | Side Scheme | Brotherhood | - | 3 pips | `mut_gen` |
| `32080` | Mystique | Minion | Mystique | HP:9 | 3 pips | `mut_gen` |
| `32081` | Metamorphic Mayhem | Side Scheme | Mystique | - | 3 pips | `mut_gen` |
| `32082` | Infiltration | Treachery | Mystique | - | 1 pips | `mut_gen` |
| `32083` | Shapeshifter Surprise | Treachery | Mystique | - | 2 pips | `mut_gen` |
...
| `32088a` | Mutants at the Mall | Side Scheme | Project Wideawake | - | - | `mut_gen` |
| `32088b` | Jubilee | Ally | Project Wideawake | THW:1 ATK:1 HP:3 | - | `mut_gen` |
| `32089` | Rictor | Ally | Project Wideawake | THW:1 ATK:1 HP:3 | - | `mut_gen` |
| `32090` | Boom Boom | Ally | Project Wideawake | THW:1 ATK:1 HP:3 | - | `mut_gen` |
| `32091` | Cannonball | Ally | Project Wideawake | THW:1 ATK:2 HP:3 | - | `mut_gen` |
| `32092` | Wolfsbane | Ally | Project Wideawake | THW:1 ATK:2 HP:3 | - | `mut_gen` |
| `32093` | Sentinel Mark IV | Minion | Project Wideawake | SCH:2 ATK:2 HP:4 | Star | `mut_gen` |
| `32094` | Gauntlet Beam | Attachment | Project Wideawake | ATK:1 | 1 pips | `mut_gen` |
| `32095` | Learning A.I. | Attachment | Project Wideawake | SCH:1 | Star | `mut_gen` |
| `32096` | Adaptive Armor | Attachment | Project Wideawake | - | Star | `mut_gen` |
| `32097` | Self-Repair | Treachery | Project Wideawake | - | Star | `mut_gen` |
| `32098` | Mutant Detected | Treachery | Project Wideawake | - | 2 pips | `mut_gen` |
| `32099` | Warn the Others | Obligation | Project Wideawake | - | 2 pips | `mut_gen` |
| `32100` | Abduction Protocols | Side Scheme | Project Wideawake | - | 2 pips | `mut_gen` |
| `32101` | Sentinel Mark II | Minion | Zero Tolerance | SCH:1 ATK:2 HP:2 | 1 pips | `mut_gen` |
| `32102` | Sentinel Mark III | Minion | Zero Tolerance | SCH:2 ATK:3 HP:3 | Star | `mut_gen` |
| `32103` | Energy Barrier | Attachment | Zero Tolerance | ATK:2 | 1 pips | `mut_gen` |
| `32104` | Operation Zero Tolerance | Side Scheme | Zero Tolerance | - | 3 pips | `mut_gen` |
| `32105` | Sentinel Mark V | Minion | Sentinels | SCH:1 ATK:3 HP:5 | 2 pips | `mut_gen` |
| `32106` | Sentinel Mark VI | Minion | Sentinels | SCH:2 ATK:2 HP:6 | Star | `mut_gen` |
| `32107` | Targeted for Elimination | Attachment | Sentinels | - | 2 pips | `mut_gen` |
| `32108` | Relentless Robots | Side Scheme | Sentinels | - | 3 pips | `mut_gen` |
...
| `32114` | Sentinel Mark VIII | Minion | Master Mold | SCH:3 ATK:3 HP:8 | 2 pips | `mut_gen` |
| `32115` | Unit Upgrade | Attachment | Master Mold | SCH:1 ATK:1 | Star | `mut_gen` |
| `32116` | Stun Beam | Attachment | Master Mold | ATK:1 | 2 pips | `mut_gen` |
| `32117` | Master Mold's Children | Treachery | Master Mold | - | 1 pips | `mut_gen` |
| `32118` | Shields Up | Treachery | Master Mold | - | Star | `mut_gen` |
| `32119` | Intruder Alert! | Side Scheme | Master Mold | - | 3 pips | `mut_gen` |
| `32120` | Insert Virus Program | Side Scheme | Master Mold | - | 2 pips | `mut_gen` |
...
| `32131` | Brotherhood Beatdown | Treachery | Mansion Attack | - | 2 pips | `mut_gen` |
| `32132` | Ground Swell | Treachery | Mansion Attack | - | 1 pips | `mut_gen` |
| `32133` | Immovable | Treachery | Mansion Attack | - | 1 pips | `mut_gen` |
| `32134` | Pyromaniac | Treachery | Mansion Attack | - | 1 pips | `mut_gen` |
| `32135` | Hopping Mad | Treachery | Mansion Attack | - | 1 pips | `mut_gen` |
| `32136` | Protect the Students | Side Scheme | Mansion Attack | - | 2 pips | `mut_gen` |
| `32137` | Under Siege | Side Scheme | Mansion Attack | - | 3 pips | `mut_gen` |
...
| `32144a` | Boarding Party | Side Scheme | Magneto | - | - | `mut_gen` |
| `32144b` | Sabotage Master Mold | Side Scheme | Magneto | - | - | `mut_gen` |
| `32145a` | Orbital Decay | Side Scheme | Magneto | - | - | `mut_gen` |
| `32145b` | Physical Strain | Attachment | Magneto | - | - | `mut_gen` |
| `32146` | M-Type Sentinel | Minion | Magneto | SCH:2 ATK:2 HP:5 | Star | `mut_gen` |
| `32147` | Magneto's Helmet | Attachment | Magneto | SCH:1 | 3 pips | `mut_gen` |
| `32148` | Magneto's Armor | Attachment | Magneto | ATK:1 | 3 pips | `mut_gen` |
| `32149` | Magnetic Bubble | Attachment | Magneto | - | 2 pips | `mut_gen` |
| `32150` | Wrapped in Metal | Attachment | Magneto | - | 2 pips | `mut_gen` |
| `32151` | Master of Magnetism | Treachery | Magneto | - | 2 pips | `mut_gen` |
| `32152` | Electric Shock | Treachery | Magneto | - | 2 pips | `mut_gen` |
| `32153` | Electromagnetic Blast | Treachery | Magneto | - | Star | `mut_gen` |
| `32154` | Metal Shards | Treachery | Magneto | - | Star | `mut_gen` |
| `32155` | Magnetic Missile | Treachery | Magneto | - | 1 pips | `mut_gen` |
| `32156` | Magnetic Mayhem | Side Scheme | Magneto | - | 4 pips | `mut_gen` |
| `32157` | Magnetically Sealed | Side Scheme | Magneto | - | Star | `mut_gen` |
| `32158` | Seized! | Side Scheme | Magneto | - | 3 pips | `mut_gen` |
| `32159` | Fabian Cortez | Minion | Acolytes | SCH:1 ATK:1 HP:4 | 3 pips | `mut_gen` |
| `32160` | Amelia Voght | Minion | Acolytes | SCH:2 ATK:1 HP:5 | 2 pips | `mut_gen` |
| `32161` | Senyaka | Minion | Acolytes | SCH:1 ATK:3 HP:3 | 3 pips | `mut_gen` |
| `32162` | Delgado | Minion | Acolytes | SCH:1 ATK:2 HP:6 | 2 pips | `mut_gen` |
| `32163` | Unuscione | Minion | Acolytes | SCH:2 ATK:2 HP:4 | 2 pips | `mut_gen` |
| `32164` | Zeal for the Cause | Treachery | Acolytes | - | 1 pips | `mut_gen` |
| `32165` | The Acolytes | Side Scheme | Acolytes | - | Star | `mut_gen` |
| `32166` | Nimrod | Minion | Future Past | SCH:2 ATK:3 HP:9 | 3 pips | `mut_gen` |
| `32167` | Bastion | Minion | Future Past | SCH:2 ATK:2 HP:10 | Star | `mut_gen` |
| `32168` | Nimrod's Portal | Side Scheme | Future Past | - | 3 pips | `mut_gen` |
| `32169` | Bastion's Machinations | Side Scheme | Future Past | - | 3 pips | `mut_gen` |
| `32170` | Nano-Sentinel Tech | Attachment | Future Past | - | 2 pips | `mut_gen` |
| `32171a` | Frightened Police | Side Scheme | Mutant Genesis Campaign | - | 3 pips | `mut_gen` |
| `32171b` | Metro P.D. | Support | Mutant Genesis Campaign | - | - | `mut_gen` |
| `32172a` | Enemy of My Enemy | Side Scheme | Mutant Genesis Campaign | - | - | `mut_gen` |
| `32172b` | Magneto | Ally | Mutant Genesis Campaign | THW:2 ATK:3 HP:5 | - | `mut_gen` |
| `32173a` | Find the Prisoners | Side Scheme | Mutant Genesis Campaign | - | 3 pips | `mut_gen` |
| `32173b` | Rescue Captives | Environment | Mutant Genesis Campaign | - | 2 pips | `mut_gen` |
| `32174a` | Surprise Attack | Side Scheme | Mutant Genesis Campaign | - | 3 pips | `mut_gen` |
| `32174b` | Reactive Defense | Obligation | Mutant Genesis Campaign | - | 2 pips | `mut_gen` |
| `32175a` | Magneto's Fortress | Side Scheme | Mutant Genesis Campaign | - | 3 pips | `mut_gen` |
| `32175b` | Magneto's Power | Attachment | Mutant Genesis Campaign | SCH:1 ATK:1 | - | `mut_gen` |
| `32176` | Coup de Grâce | Upgrade | Brawler | - | - | `mut_gen` |
| `32177` | Swagger | Upgrade | Brawler | - | - | `mut_gen` |
| `32178` | Brazen Defense | Upgrade | Brawler | - | - | `mut_gen` |
| `32179` | Ferocious Attack | Upgrade | Brawler | - | - | `mut_gen` |
| `32180` | War Cry | Upgrade | Brawler | - | - | `mut_gen` |
| `32181` | Coup de Grâce | Upgrade | Commander | - | - | `mut_gen` |
| `32182` | Compassion | Upgrade | Commander | - | - | `mut_gen` |
| `32183` | Group Assault | Upgrade | Commander | - | - | `mut_gen` |
| `32184` | Shock and Awe | Upgrade | Commander | - | - | `mut_gen` |
| `32185` | Improvisation | Upgrade | Commander | - | - | `mut_gen` |
| `32186` | Swagger | Upgrade | Defender | - | - | `mut_gen` |
| `32187` | Surprise! | Upgrade | Defender | - | - | `mut_gen` |
| `32188` | Heroic Intervention | Upgrade | Defender | - | - | `mut_gen` |
| `32189` | Determined Defense | Upgrade | Defender | - | - | `mut_gen` |
| `32190` | Bodyguard | Upgrade | Defender | - | - | `mut_gen` |
| `32191` | Surprise! | Upgrade | Peacekeeper | - | - | `mut_gen` |
| `32192` | Compassion | Upgrade | Peacekeeper | - | - | `mut_gen` |
| `32193` | Rescue Operation | Upgrade | Peacekeeper | - | - | `mut_gen` |
| `32194` | Mentorship | Upgrade | Peacekeeper | - | - | `mut_gen` |
| `32195` | Fortitude | Upgrade | Peacekeeper | - | - | `mut_gen` |
...
- **Stats**: **Base Threat**: 0 per hero, **Escalation Threat**: +1 per hero/round
- **Bottom-Right Encounter Logos**:
  - **Encounter Set Emblem**: Sabretooth Set Icon (printed bottom-right next to deck number)
- **Rules Text**:
