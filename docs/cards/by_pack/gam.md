...
| `18001b` | Gamora | Alter-Ego | Gamora | HP:10 | - | `gam` |
...
| `18024` | Unfulfilled Destiny | Obligation | Gamora | - | 2 pips | `gam` |
| `18025` | Sibling Rivalry | Side Scheme | Gamora Nemesis | - | 3 pips | `gam` |
| `18026` | Nebula | Minion | Gamora Nemesis | SCH:1 ATK:2 HP:5 | 3 pips | `gam` |
| `18027` | In a Bind | Attachment | Gamora Nemesis | - | 1 pips | `gam` |
| `18028` | Waylay | Treachery | Gamora Nemesis | - | 2 pips | `gam` |
