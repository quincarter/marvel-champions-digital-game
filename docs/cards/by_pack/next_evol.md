...
| `40001b` | Nathan Summers | Alter-Ego | Cable | HP:12 | - | `next_evol` |
...
| `40031` | Technovirus Resurgence | Obligation | Cable | - | 2 pips | `next_evol` |
| `40032` | Stryfe | Minion | Cable Nemesis | SCH:2 ATK:2 HP:5 | 3 pips | `next_evol` |
| `40033` | Back to the Future | Side Scheme | Cable Nemesis | - | 2 pips | `next_evol` |
| `40034` | Telekinetic Force Field | Attachment | Cable Nemesis | - | 1 pips | `next_evol` |
| `40035` | Mind Scan | Treachery | Cable Nemesis | - | Star | `next_evol` |
| `40036` | Telekinetic Blast | Treachery | Cable Nemesis | - | Star | `next_evol` |
| `40037a` | Domino | Hero | Domino | THW:1 ATK:2 DEF:3 HP:9 | - | `next_evol` |
| `40037b` | Neena Thurman | Alter-Ego | Domino | HP:9 | - | `next_evol` |
...
| `40065` | Memories of Armageddon | Obligation | Domino | - | 2 pips | `next_evol` |
| `40066` | Topaz | Minion | Domino Nemesis | SCH:1 ATK:2 HP:3 | 3 pips | `next_evol` |
| `40067` | Not My Lucky Day | Side Scheme | Domino Nemesis | - | 2 pips | `next_evol` |
| `40068` | Prototype | Minion | Domino Nemesis | SCH:2 ATK:2 HP:1 | 2 pips | `next_evol` |
| `40069` | Superpower Feedback | Attachment | Domino Nemesis | - | 1 pips | `next_evol` |
...
| `40079` | Morlock | Ally | Morlock Siege | THW:1 ATK:1 HP:5 | - | `next_evol` |
| `40080` | Hide! | Treachery | Morlock Siege | - | Star | `next_evol` |
| `40081a` | Routed | Environment | Morlock Siege | - | - | `next_evol` |
| `40081b` | Routed | Environment | Morlock Siege | - | - | `next_evol` |
| `40082` | Bolstered by Wrath | Attachment | Morlock Siege | SCH:1 ATK:1 | 1 pips | `next_evol` |
| `40083` | Pushed to the Limit | Attachment | Morlock Siege | ATK:1 | 3 pips | `next_evol` |
| `40084` | By Any Means | Side Scheme | Morlock Siege | - | 3 pips | `next_evol` |
| `40085` | In the Midst of Chaos | Side Scheme | Morlock Siege | - | 1 pips | `next_evol` |
| `40086` | Maraudin' Ain't Easy | Side Scheme | Morlock Siege | - | 2 pips | `next_evol` |
| `40087` | Territorial Control | Side Scheme | Morlock Siege | - | 2 pips | `next_evol` |
| `40088` | Back in Action | Treachery | Morlock Siege | - | 1 pips | `next_evol` |
| `40089` | Seek the Weak | Treachery | Morlock Siege | - | 1 pips | `next_evol` |
| `40090` | Heavy Armament | Attachment | Military Grade | ATK:2 | 3 pips | `next_evol` |
| `40091` | Titanium Exoskeleton | Attachment | Military Grade | - | 2 pips | `next_evol` |
| `40092` | Inhibitor Collar | Attachment | Military Grade | ATK:-1 | 1 pips | `next_evol` |
| `40093` | The Senator's Support | Side Scheme | Military Grade | - | 2 pips | `next_evol` |
| `40094` | Arclight | Minion | Mutant Slayers | SCH:1 ATK:1 HP:5 | 1 pips | `next_evol` |
| `40095` | Blockbuster | Minion | Mutant Slayers | SCH:0 ATK:2 HP:5 | 2 pips | `next_evol` |
| `40096` | Chimera | Minion | Mutant Slayers | SCH:1 ATK:1 HP:5 | 3 pips | `next_evol` |
| `40097` | Greycrow | Minion | Mutant Slayers | SCH:1 ATK:1 HP:4 | 3 pips | `next_evol` |
| `40098` | Harpoon | Minion | Mutant Slayers | SCH:0 ATK:2 HP:5 | 1 pips | `next_evol` |
| `40099` | Riptide | Minion | Mutant Slayers | SCH:1 ATK:1 HP:4 | 1 pips | `next_evol` |
| `40100` | Vertigo | Minion | Mutant Slayers | SCH:1 ATK:0 HP:4 | 2 pips | `next_evol` |
| `40101` | Mutant Slayers | Side Scheme | Mutant Slayers | - | 2 pips | `next_evol` |
| `40102` | Bound by Business | Treachery | Mutant Slayers | - | 1 pips | `next_evol` |
...
| `40105a` | Hope's Captor | Attachment | On the Run | - | - | `next_evol` |
| `40105b` | Hope's Captor | Attachment | On the Run | SCH:1 ATK:1 | - | `next_evol` |
| `40106` | Hidden in the Clutter | Attachment | On the Run | - | 2 pips | `next_evol` |
| `40107` | Favored Weapon | Attachment | On the Run | ATK:1 | - | `next_evol` |
| `40108` | Bushwhack | Side Scheme | On the Run | - | 3 pips | `next_evol` |
| `40109` | Pure Force | Side Scheme | On the Run | - | 3 pips | `next_evol` |
| `40110` | Dizzying Deeds | Treachery | On the Run | - | 2 pips | `next_evol` |
| `40111` | Tag Team | Treachery | On the Run | - | 2 pips | `next_evol` |
| `40112` | Gorgeous George | Minion | Nasty Boys | SCH:1 ATK:2 HP:4 | 1 pips | `next_evol` |
| `40113` | Hairbag | Minion | Nasty Boys | SCH:1 ATK:2 HP:3 | 2 pips | `next_evol` |
| `40114` | Ramrod | Minion | Nasty Boys | SCH:1 ATK:2 HP:4 | 1 pips | `next_evol` |
| `40115` | Ruckus | Minion | Nasty Boys | SCH:2 ATK:1 HP:3 | 1 pips | `next_evol` |
| `40116` | Slab | Minion | Nasty Boys | SCH:1 ATK:1 HP:5 | 2 pips | `next_evol` |
| `40117` | Get Nasty | Side Scheme | Nasty Boys | - | 3 pips | `next_evol` |
...
| `40122a` | Juggernaut's Helmet | Attachment | Juggernaut | - | - | `next_evol` |
| `40122b` | Juggernaut Exposed | Attachment | Juggernaut | - | - | `next_evol` |
| `40123` | Head of Steam | Attachment | Juggernaut | - | 3 pips | `next_evol` |
| `40124` | Building Momentum | Side Scheme | Juggernaut | - | 2 pips | `next_evol` |
| `40125` | Breakthrough | Treachery | Juggernaut | - | 2 pips | `next_evol` |
| `40126` | Flatten | Treachery | Juggernaut | - | 1 pips | `next_evol` |
| `40127` | Ground Pound | Treachery | Juggernaut | - | 1 pips | `next_evol` |
| `40128` | Trample | Treachery | Juggernaut | - | 1 pips | `next_evol` |
| `40129` | Cyttorak's Exemplar | Treachery | Juggernaut | - | 3 pips | `next_evol` |
| `40130` | Hope Summers | Ally | Hope Summers | HP:3 | - | `next_evol` |
| `40131` | Captive Hope | Side Scheme | Hope Summers | - | 3 pips | `next_evol` |
| `40132` | Black Tom Cassidy | Minion | Black Tom Cassidy | SCH:1 ATK:1 HP:6 | 3 pips | `next_evol` |
| `40133` | Creeping Willow | Minion | Black Tom Cassidy | SCH:0 ATK:1 HP:3 | 1 pips | `next_evol` |
| `40134` | Making Green | Side Scheme | Black Tom Cassidy | - | 2 pips | `next_evol` |
| `40135` | A Sound Thrashing | Treachery | Black Tom Cassidy | - | 3 pips | `next_evol` |
...
| `40144` | Sinister Disguise | Attachment | Mister Sinister | - | 2 pips | `next_evol` |
| `40145` | Sinister Soldier | Minion | Mister Sinister | SCH:1 ATK:1 HP:5 | Star | `next_evol` |
| `40146` | Teleported Away | Side Scheme | Mister Sinister | - | 2 pips | `next_evol` |
| `40147` | Genetic Mastery | Treachery | Mister Sinister | - | 2 pips | `next_evol` |
| `40148` | Molecular Control | Treachery | Mister Sinister | - | 1 pips | `next_evol` |
| `40149` | Sinister Schemes | Treachery | Mister Sinister | - | 1 pips | `next_evol` |
| `40150` | Sinister Strike | Treachery | Mister Sinister | - | 1 pips | `next_evol` |
| `40151` | Flight | Attachment | Flight | ATK:1 | - | `next_evol` |
| `40152` | Aerial Bombardment | Attachment | Flight | - | 2 pips | `next_evol` |
| `40153` | Out of Reach | Attachment | Flight | - | 2 pips | `next_evol` |
| `40154` | High Ground | Attachment | Flight | - | 1 pips | `next_evol` |
| `40155` | Super Strength | Attachment | Super Strength | ATK:1 | - | `next_evol` |
| `40156` | Impervious | Attachment | Super Strength | - | 2 pips | `next_evol` |
| `40157` | Thrown Object | Attachment | Super Strength | ATK:3 | 3 pips | `next_evol` |
| `40158` | "I'll Take That" | Treachery | Super Strength | - | 2 pips | `next_evol` |
| `40159` | Telepathy | Attachment | Telepathy | SCH:1 | - | `next_evol` |
| `40160` | Manufactured Drama | Obligation | Telepathy | - | 2 pips | `next_evol` |
| `40161` | Sowing Discord | Obligation | Telepathy | - | 2 pips | `next_evol` |
| `40162` | One Step Ahead | Treachery | Telepathy | - | 1 pips | `next_evol` |
...
| `40168a` | Stryfe's Grasp | Side Scheme | Stryfe | - | - | `next_evol` |
| `40168b` | Living Bomb | Side Scheme | Stryfe | - | - | `next_evol` |
| `40169` | Mental Transferal | Attachment | Stryfe | - | 2 pips | `next_evol` |
| `40170` | Mind Alteration | Attachment | Stryfe | - | 2 pips | `next_evol` |
| `40171` | Mind Trap | Attachment | Stryfe | - | 2 pips | `next_evol` |
| `40172` | Psionic Amnesia | Attachment | Stryfe | - | 2 pips | `next_evol` |
| `40173` | Psychic Inertia | Attachment | Stryfe | SCH:-1 ATK:-1 | 1 pips | `next_evol` |
| `40174` | Zero | Minion | Stryfe | SCH:1 ATK:1 HP:4 | 1 pips | `next_evol` |
| `40175` | Cerebral Erasure | Side Scheme | Stryfe | - | 2 pips | `next_evol` |
| `40176` | Telepathic Camouflage | Side Scheme | Stryfe | - | 3 pips | `next_evol` |
| `40177` | Psionic Surge | Treachery | Stryfe | - | 2 pips | `next_evol` |
| `40178` | Psychic Override | Treachery | Stryfe | - | 1 pips | `next_evol` |
| `40179` | Telekinetic Wave | Treachery | Stryfe | - | 1 pips | `next_evol` |
| `40180` | Strobe | Minion | Extreme Measures | SCH:2 ATK:2 HP:4 | 2 pips | `next_evol` |
| `40181` | Tempo | Minion | Extreme Measures | SCH:1 ATK:1 HP:5 | - | `next_evol` |
| `40182` | Thumbelina | Minion | Extreme Measures | SCH:1 ATK:1 HP:3 | 1 pips | `next_evol` |
| `40183` | Wildside | Minion | Extreme Measures | SCH:0 ATK:3 HP:5 | 3 pips | `next_evol` |
| `40184` | Extreme Measures | Side Scheme | Extreme Measures | - | 1 pips | `next_evol` |
| `40185` | Dragoness | Minion | Mutant Insurrection | SCH:1 ATK:1 HP:3 | 2 pips | `next_evol` |
| `40186` | Forearm | Minion | Mutant Insurrection | SCH:0 ATK:4 HP:6 | 4 pips | `next_evol` |
| `40187` | Reaper | Minion | Mutant Insurrection | SCH:1 ATK:2 HP:4 | 2 pips | `next_evol` |
| `40188` | Samurai | Minion | Mutant Insurrection | SCH:1 ATK:2 HP:5 | 2 pips | `next_evol` |
| `40189` | Mutant Insurrection | Side Scheme | Mutant Insurrection | - | 2 pips | `next_evol` |
| `40190a` | Assemble the Team | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40190b` | Team Assembled | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40191a` | Establish Safehouse | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40191b` | Safehouse Established | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40192a` | Gear Up | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40192b` | Geared Up | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40193a` | Mission Prep | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40193b` | Mission Prepped | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40194a` | Practice Maneuvers | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40194b` | Practiced Maneuvers | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40195a` | Prepare Defenses | Player Side Scheme | Next Evolution Campaign | - | - | `next_evol` |
| `40195b` | Prepared Defenses | Environment | Next Evolution Campaign | - | - | `next_evol` |
| `40196` | Pouches | Resource | Next Evolution Campaign | - | - | `next_evol` |
| `40197` | Safehouse | Support | Next Evolution Campaign | - | - | `next_evol` |
| `40198` | Lady Mastermind | Minion | Next Evolution Campaign | SCH:1 ATK:1 HP:3 | 2 pips | `next_evol` |
| `40199` | Malice | Minion | Next Evolution Campaign | SCH:1 ATK:1 HP:1 | 3 pips | `next_evol` |
| `40200` | Scrambler | Minion | Next Evolution Campaign | SCH:1 ATK:1 HP:3 | 3 pips | `next_evol` |
| `40201` | Vanisher | Minion | Next Evolution Campaign | SCH:1 ATK:1 HP:3 | 2 pips | `next_evol` |
| `40202` | Under Pressure | Side Scheme | Next Evolution Campaign | - | 2 pips | `next_evol` |
| `40203` | Overburdened | Treachery | Next Evolution Campaign | - | 1 pips | `next_evol` |
...
- **Properties**: Stage 1, Double-Sided
- **Stats**: **Base Threat**: 0, **Target Threat**: 9 per hero, **Escalation Threat**: +0 per hero/round
- **Bottom-Right Encounter Logos**:
  - **Encounter Set Emblem**: Stryfe Set Icon (printed bottom-right next to deck number)
- **Rules Text**:
