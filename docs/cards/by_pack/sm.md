...
| `27001b` | Gwen Stacy | Alter-Ego | Ghost-Spider | HP:10 | - | `sm` |
...
| `27025` | Worried Father | Obligation | Ghost-Spider | - | 2 pips | `sm` |
| `27026` | Regenerative Research | Side Scheme | Ghost-Spider Nemesis | - | 3 pips | `sm` |
| `27027` | The Lizard | Minion | Ghost-Spider Nemesis | SCH:1 ATK:3 HP:5 | 2 pips | `sm` |
| `27028` | Experimental Injection | Attachment | Ghost-Spider Nemesis | - | - | `sm` |
| `27029` | In Cold Blood | Treachery | Ghost-Spider Nemesis | - | 1 pips | `sm` |
| `27030a` | Spider-Man | Hero | Spider-Man - Miles Morales | THW:2 ATK:2 DEF:2 HP:9 | - | `sm` |
| `27030b` | Miles Morales | Alter-Ego | Spider-Man - Miles Morales | HP:9 | - | `sm` |
...
| `27056` | Keeping Secrets | Obligation | Spider-Man - Miles Morales | - | 2 pips | `sm` |
| `27057` | Tracking Prey | Side Scheme | Spider-Man - Morales Nemesis | - | 3 pips | `sm` |
| `27058` | Prowler | Minion | Spider-Man - Morales Nemesis | SCH:1 ATK:2 HP:5 | 2 pips | `sm` |
| `27059` | Razor Claws | Attachment | Spider-Man - Morales Nemesis | ATK:2 | 2 pips | `sm` |
| `27060` | Slice and Dice | Treachery | Spider-Man - Morales Nemesis | - | 1 pips | `sm` |
...
| `27066` | Sand Form | Attachment | Sandman | - | Star | `sm` |
| `27067` | Sand Clone | Minion | Sandman | SCH:1 ATK:-1 HP:3 | - | `sm` |
| `27068` | Dirt Trap | Side Scheme | Sandman | - | 3 pips | `sm` |
| `27069` | Tidal Sands | Side Scheme | Sandman | - | 2 pips | `sm` |
| `27070` | Sandslide | Treachery | Sandman | - | Star | `sm` |
| `27071` | Sand Storm | Treachery | Sandman | - | 2 pips | `sm` |
| `27072` | Sand Smash | Treachery | Sandman | - | 1 pips | `sm` |
...
| `27078` | "Now We're Angry!" | Attachment | Venom | ATK:1 | Star | `sm` |
| `27079` | Guard the Bell Tower | Side Scheme | Venom | - | 2 pips | `sm` |
| `27080` | Lashing Out | Side Scheme | Venom | - | 1 pips | `sm` |
| `27081` | Tooth and Nail | Side Scheme | Venom | - | 2 pips | `sm` |
| `27082` | Biting Retort | Treachery | Venom | - | 1 pips | `sm` |
| `27083` | For Whom the Bell Tolls | Treachery | Venom | - | Star | `sm` |
...
| `27089` | Humongous Hallucination | Attachment | Mysterio | - | 3 pips | `sm` |
| `27090` | Masterful Mirage | Attachment | Mysterio | - | 1 pips | `sm` |
| `27091` | Shifting Apparition | Minion | Mysterio | SCH:1 ATK:1 HP:1 | 1 pips | `sm` |
| `27092` | Déjà Vu | Treachery | Mysterio | - | Star | `sm` |
| `27093` | Fearmonger | Treachery | Mysterio | - | Star | `sm` |
...
| `27102a` | Light at the End | Side Scheme | The Sinister Six | - | - | `sm` |
| `27102b` | Light at the End | Side Scheme | The Sinister Six | - | - | `sm` |
| `27103` | Heightened Morale | Attachment | The Sinister Six | ATK:-1 | - | `sm` |
| `27104` | Taunting Presence | Attachment | The Sinister Six | - | 2 pips | `sm` |
| `27105` | Team Leader | Attachment | The Sinister Six | - | 1 pips | `sm` |
| `27106` | Take One for the Team | Attachment | The Sinister Six | - | 1 pips | `sm` |
| `27107` | Brute Force Barricade | Side Scheme | The Sinister Six | - | 2 pips | `sm` |
| `27108` | Frequent Flyers | Treachery | The Sinister Six | - | 3 pips | `sm` |
| `27109` | High Fashion | Treachery | The Sinister Six | - | 3 pips | `sm` |
| `27110` | Robotic Enhancements | Treachery | The Sinister Six | - | 3 pips | `sm` |
| `27111` | Partnership of Pain | Treachery | The Sinister Six | - | 2 pips | `sm` |
| `27112` | Surprise! | Treachery | The Sinister Six | - | 1 pips | `sm` |
...
| `27120` | We Are One | Attachment | Venom Goblin | SCH:3 ATK:3 | 3 pips | `sm` |
| `27121` | Symbiotic Berserker | Minion | Venom Goblin | SCH:0 ATK:3 HP:5 | Star | `sm` |
| `27122` | Symbiotic Monstrosity | Minion | Venom Goblin | SCH:2 ATK:2 HP:6 | 3 pips | `sm` |
| `27123` | Symbiotic Thrall | Minion | Venom Goblin | SCH:1 ATK:2 HP:4 | Star | `sm` |
| `27124` | Festering Mass | Side Scheme | Venom Goblin | - | Star | `sm` |
| `27125` | Joy Ride | Side Scheme | Venom Goblin | - | 2 pips | `sm` |
| `27126` | Spreading Panic | Treachery | Venom Goblin | - | Star | `sm` |
| `27127` | Panic in the Streets | Side Scheme | City in Chaos | - | 2 pips | `sm` |
| `27128` | Rhino | Minion | City in Chaos | SCH:0 ATK:3 HP:8 | 3 pips | `sm` |
| `27129` | Calling in Favors | Treachery | City in Chaos | - | 2 pips | `sm` |
| `27130` | Now or Never | Treachery | City in Chaos | - | 1 pips | `sm` |
| `27131` | Common Criminal | Minion | Down to Earth | SCH:0 ATK:1 HP:3 | 1 pips | `sm` |
| `27132` | Friends and Family | Obligation | Down to Earth | - | 3 pips | `sm` |
| `27133` | Volunteer Work | Side Scheme | Down to Earth | - | 2 pips | `sm` |
| `27134` | "Threat or Menace?" | Treachery | Down to Earth | - | - | `sm` |
| `27135` | Loose Ends | Treachery | Down to Earth | - | - | `sm` |
| `27136` | Advanced Glider | Attachment | Goblin Gear | - | 3 pips | `sm` |
| `27137` | Concussive Bombs | Attachment | Goblin Gear | ATK:1 | 2 pips | `sm` |
| `27138` | Incendiary Bombs | Attachment | Goblin Gear | ATK:1 | 1 pips | `sm` |
| `27139` | Smoke Bombs | Attachment | Goblin Gear | ATK:1 | 1 pips | `sm` |
| `27140` | Limitless Supply | Side Scheme | Goblin Gear | - | 3 pips | `sm` |
| `27141` | Remote Navigation | Treachery | Goblin Gear | - | Star | `sm` |
| `27142` | Life-Size Decoy | Minion | Guerrilla Tactics | SCH:0 ATK:0 HP:5 | Star | `sm` |
| `27143` | Coordinated Effort | Side Scheme | Guerrilla Tactics | - | 1 pips | `sm` |
| `27144` | Hidden in Shadow | Side Scheme | Guerrilla Tactics | - | 1 pips | `sm` |
| `27145` | Teamwork Makes the Dream Work | Side Scheme | Guerrilla Tactics | - | 2 pips | `sm` |
| `27146` | From Every Direction | Treachery | Guerrilla Tactics | - | - | `sm` |
| `27147` | Arm Cannon | Attachment | Osborn Tech | - | 3 pips | `sm` |
| `27148` | Ionic Boots | Attachment | Osborn Tech | - | 3 pips | `sm` |
| `27149` | Kinetic Armor | Attachment | Osborn Tech | - | 3 pips | `sm` |
| `27150` | Neocarbon Scales | Attachment | Osborn Tech | - | 3 pips | `sm` |
| `27151` | Spiked Gauntlet | Attachment | Osborn Tech | ATK:1 | 3 pips | `sm` |
| `27152` | Tracking Display | Attachment | Osborn Tech | - | 3 pips | `sm` |
| `27153` | Induced Panic | Attachment | Personal Nightmare | - | 1 pips | `sm` |
| `27154` | Evil Doppelgänger | Minion | Personal Nightmare | SCH:1 ATK:1 HP:5 | 2 pips | `sm` |
| `27155` | Fool's Paradise | Side Scheme | Personal Nightmare | - | 3 pips | `sm` |
| `27156` | Weakness from Within | Side Scheme | Personal Nightmare | - | 2 pips | `sm` |
| `27157` | Deepest Fears | Treachery | Personal Nightmare | - | - | `sm` |
| `27158` | Doctor Octopus | Minion | Sinister Assault | SCH:2 ATK:2 HP:6 | 3 pips | `sm` |
| `27159` | Electro | Minion | Sinister Assault | SCH:2 ATK:1 HP:6 | 3 pips | `sm` |
| `27160` | Hobgoblin | Minion | Sinister Assault | SCH:1 ATK:2 HP:6 | 3 pips | `sm` |
| `27161` | Kraven the Hunter | Minion | Sinister Assault | SCH:1 ATK:2 HP:6 | 3 pips | `sm` |
| `27162` | Scorpion | Minion | Sinister Assault | SCH:1 ATK:3 HP:6 | 3 pips | `sm` |
| `27163` | Vulture | Minion | Sinister Assault | SCH:1 ATK:1 HP:6 | 3 pips | `sm` |
| `27164` | Improvised Weapons | Attachment | Symbiotic Strength | - | 1 pips | `sm` |
| `27165` | Violent Tendencies | Attachment | Symbiotic Strength | - | 2 pips | `sm` |
| `27166` | Webbed Up | Attachment | Symbiotic Strength | - | Star | `sm` |
| `27167` | Enraged Symbiote | Minion | Symbiotic Strength | SCH:1 ATK:2 HP:2 | Star | `sm` |
| `27168` | Swinging Assault | Treachery | Symbiotic Strength | - | 2 pips | `sm` |
| `27169` | Unstable Sentience | Treachery | Symbiotic Strength | - | Star | `sm` |
| `27170` | Delusion of Collusion | Attachment | Whispers of Paranoia | - | 1 pips | `sm` |
| `27171` | Manipulated Mind | Attachment | Whispers of Paranoia | - | 2 pips | `sm` |
| `27172` | Old Grudge | Attachment | Whispers of Paranoia | - | 2 pips | `sm` |
| `27173` | Analysis Paralysis | Side Scheme | Whispers of Paranoia | - | 3 pips | `sm` |
| `27174a` | Public Outcry | Environment | Bad Publicity | - | - | `sm` |
| `27174b` | Public Outcry | Environment | Bad Publicity | - | - | `sm` |
| `27175` | Smear Campaign | Treachery | Bad Publicity | - | 3 pips | `sm` |
| `27176` | Back Alley Burglary | Side Scheme | Community Service | - | 3 pips | `sm` |
| `27177` | Cat in a Tree | Side Scheme | Community Service | - | 3 pips | `sm` |
| `27178` | Henchmen Heist | Side Scheme | Community Service | - | 3 pips | `sm` |
| `27179` | Off the Rails | Side Scheme | Community Service | - | 3 pips | `sm` |
| `27180` | Rubble Rescue | Side Scheme | Community Service | - | 3 pips | `sm` |
| `27181` | Snitches Get Stitches | Attachment | Snitches get Stitches | - | 3 pips | `sm` |
| `27182a` | Compact Darts | Upgrade | Shield Tech | - | - | `sm` |
| `27182b` | Compact Darts | Upgrade | Shield Tech | - | - | `sm` |
| `27183a` | Impact-Dampening Suit | Upgrade | Shield Tech | - | - | `sm` |
| `27183b` | Impact-Dampening Suit | Upgrade | Shield Tech | - | - | `sm` |
| `27184a` | Laser Goggles | Upgrade | Shield Tech | - | - | `sm` |
| `27184b` | Laser Goggles | Upgrade | Shield Tech | - | - | `sm` |
| `27185a` | Propulsion Gauntlet | Upgrade | Shield Tech | - | - | `sm` |
| `27185b` | Propulsion Gauntlet | Upgrade | Shield Tech | - | - | `sm` |
| `27186a` | Retinal Display | Upgrade | Shield Tech | - | - | `sm` |
| `27186b` | Retinal Display | Upgrade | Shield Tech | - | - | `sm` |
| `27187a` | Shock Knuckles | Upgrade | Shield Tech | - | - | `sm` |
| `27187b` | Shock Knuckles | Upgrade | Shield Tech | - | - | `sm` |
| `27188a` | Wave Bracers | Upgrade | Shield Tech | - | - | `sm` |
| `27188b` | Wave Bracers | Upgrade | Shield Tech | - | - | `sm` |
| `27189a` | Wrist Navigator | Upgrade | Shield Tech | - | - | `sm` |
| `27189b` | Wrist Navigator | Upgrade | Shield Tech | - | - | `sm` |
