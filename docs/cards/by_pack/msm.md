...
| `05001b` | Kamala Khan | Alter-Ego | Ms. Marvel | HP:10 | - | `msm` |
...
| `05025` | Home by Dawn | Obligation | Ms. Marvel | - | 2 pips | `msm` |
| `05026` | Generation Why? | Side Scheme | Ms. Marvel Nemesis | - | 3 pips | `msm` |
| `05027` | Thomas Edison | Minion | Ms. Marvel Nemesis | SCH:3 ATK:1 HP:3 | 2 pips | `msm` |
| `05028` | Edison's Giant Robot | Minion | Ms. Marvel Nemesis | SCH:1 ATK:2 HP:8 | 1 pips | `msm` |
| `05029` | Harvest | Treachery | Ms. Marvel Nemesis | - | - | `msm` |
