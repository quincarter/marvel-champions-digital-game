...
| `33001b` | Scott Summers | Alter-Ego | Cyclops | HP:10 | - | `cyclops` |
...
| `33027` | Lost Visor | Obligation | Cyclops | - | 2 pips | `cyclops` |
| `33028` | Mister Sinister | Minion | Cyclops Nemesis | SCH:1 ATK:1 HP:6 | 2 pips | `cyclops` |
| `33029` | Genetic Manipulation | Side Scheme | Cyclops Nemesis | - | 3 pips | `cyclops` |
| `33030` | Gene Therapy | Attachment | Cyclops Nemesis | ATK:2 | 2 pips | `cyclops` |
| `33031` | Concussive Force | Treachery | Cyclops Nemesis | - | 2 pips | `cyclops` |
