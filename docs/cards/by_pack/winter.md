...
| `54001b` | Bucky Barnes | Alter-Ego | Winter Soldier | HP:11 | - | `winter` |
...
| `54027` | Red Room Programming | Obligation | Winter Soldier | - | 2 pips | `winter` |
| `54028` | Crossbones | Minion | Winter Soldier Nemesis | SCH:2 ATK:2 HP:5 | 3 pips | `winter` |
| `54029` | Hydra Hit Squad | Side Scheme | Winter Soldier Nemesis | - | 3 pips | `winter` |
| `54030` | High-Tech Armament | Attachment | Winter Soldier Nemesis | ATK:1 | 2 pips | `winter` |
| `54031` | Hydra Mercenary | Minion | Winter Soldier Nemesis | SCH:0 ATK:1 HP:3 | 1 pips | `winter` |
| `54032` | White Widow | Ally | Pack Position: 32 | THW:2 ATK:1 HP:3 | - | `winter` |
| `54033` | S.H.I.E.L.D. Deputy | Upgrade | Pack Position: 33 | - | - | `winter` |
| `54034` | Blizzard | Minion | Whiteout | SCH:1 ATK:2 HP:16 | 4 pips | `winter` |
| `54035` | Encased in Ice | Attachment | Whiteout | - | 1 pips | `winter` |
| `54036` | Slippery Conditions | Side Scheme | Whiteout | - | 3 pips | `winter` |
| `54037` | Whiteout | Treachery | Whiteout | - | 1 pips | `winter` |
