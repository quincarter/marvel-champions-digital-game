...
| `11014` | Temporal Shield | Attachment | Kang | - | 1 pips | `toafk` |
| `11015` | Future Weapon | Attachment | Kang | ATK:2 | 2 pips | `toafk` |
| `11016` | Frozen in Time | Attachment | Kang | - | Star | `toafk` |
| `11017` | Macrobots | Minion | Kang | SCH:1 ATK:2 HP:4 | Star | `toafk` |
| `11018` | Weakened | Obligation | Kang | - | 2 pips | `toafk` |
| `11019` | Stolen Memories | Obligation | Kang | - | 2 pips | `toafk` |
| `11020` | Depowered | Obligation | Kang | - | 2 pips | `toafk` |
| `11021` | Time-Travel Hijinks | Obligation | Kang | - | 2 pips | `toafk` |
| `11022` | Corrupted Timestream | Side Scheme | Kang | - | 2 pips | `toafk` |
| `11023` | Kang's Dominion | Side Scheme | Kang | - | 3 pips | `toafk` |
| `11024` | Pinned Down | Side Scheme | Kang | - | 2 pips | `toafk` |
| `11025` | Rampage | Side Scheme | Kang | - | 2 pips | `toafk` |
| `11026` | Energy Blast | Treachery | Kang | - | 1 pips | `toafk` |
| `11027` | Manipulated Timestream | Treachery | Kang | - | 2 pips | `toafk` |
| `11028` | Time-Travel Tactics | Treachery | Kang | - | 1 pips | `toafk` |
| `11029` | Past Machinations | Treachery | Kang | - | 3 pips | `toafk` |
| `11030` | Ancient Warrior | Minion | Temporal | SCH:1 ATK:2 HP:2 | Star | `toafk` |
| `11031` | Chitauri Soldier | Minion | Temporal | SCH:1 ATK:1 HP:3 | 1 pips | `toafk` |
| `11032` | Tyrannosaurus Rex | Minion | Temporal | SCH:0 ATK:3 HP:6 | 3 pips | `toafk` |
| `11033` | Time Portal | Side Scheme | Temporal | - | 2 pips | `toafk` |
...
| `11040` | Apocryphus | Minion | Anachronauts | SCH:1 ATK:3 HP:4 | Star | `toafk` |
| `11041` | Deathunt 9000 | Minion | Anachronauts | SCH:1 ATK:1 HP:6 | Star | `toafk` |
| `11042` | Sir Raston | Minion | Anachronauts | SCH:1 ATK:2 HP:6 | Star | `toafk` |
| `11043` | Terminatrix | Minion | Anachronauts | SCH:2 ATK:2 HP:5 | Star | `toafk` |
| `11044` | Wildrun | Minion | Anachronauts | SCH:1 ATK:2 HP:5 | Star | `toafk` |
| `11045` | The Anachronauts | Side Scheme | Anachronauts | - | 3 pips | `toafk` |
| `11046` | Kang's Chosen | Treachery | Anachronauts | - | 2 pips | `toafk` |
| `11047` | Kang (Master of Time) | Minion | Master of Time | SCH:1 ATK:1 HP:6 | 2 pips | `toafk` |
| `11048` | Time-Displaced Soldier | Minion | Master of Time | SCH:1 ATK:2 HP:3 | Star | `toafk` |
| `11049` | Fear of Kang | Obligation | Master of Time | - | 2 pips | `toafk` |
| `11050` | Light of Centuries Sphere | Side Scheme | Master of Time | - | 3 pips | `toafk` |
| `11051` | Ancient Grudge | Treachery | Master of Time | - | 1 pips | `toafk` |
