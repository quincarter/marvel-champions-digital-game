...
| `28001b` | Sam Alexander | Alter-Ego | Nova | HP:10 | - | `nova` |
...
| `28021` | Weight of the World | Obligation | Nova | - | 2 pips | `nova` |
| `28022` | "Bring the War!" | Side Scheme | Nova Nemesis | - | 2 pips | `nova` |
| `28023` | Warbringer | Minion | Nova Nemesis | SCH:1 ATK:3 HP:5 | 3 pips | `nova` |
| `28024` | War Delivery | Treachery | Nova Nemesis | - | 1 pips | `nova` |
| `28025` | "The War's Been Brought" | Treachery | Nova Nemesis | - | - | `nova` |
| `28026` | Yaw and Roll | Event | Pack Position: 26 | - | - | `nova` |
| `28027` | Height Advantage | Upgrade | Pack Position: 27 | - | - | `nova` |
| `28028` | Armored Assault | Side Scheme | Armadillo | - | 2 pips | `nova` |
| `28029` | Armadillo | Minion | Armadillo | SCH:1 ATK:2 HP:8 | 3 pips | `nova` |
| `28030` | Rollin', Rollin' | Attachment | Armadillo | ATK:2 | 2 pips | `nova` |
| `28031` | Tough and Tumble | Treachery | Armadillo | - | 1 pips | `nova` |
| `28032` | Tough It Out | Treachery | Armadillo | - | - | `nova` |
