...
| `24007` | Established Dominance | Attachment | The Hood | - | 2 pips | `hood` |
| `24008` | The Hood's Mantle | Attachment | The Hood | - | - | `hood` |
| `24009` | The Hood's Pistol | Attachment | The Hood | SCH:1 ATK:1 | Star | `hood` |
| `24010` | Madame Masque | Minion | The Hood | SCH:1 ATK:2 HP:4 | 3 pips | `hood` |
| `24011` | Unbridled Ambition | Side Scheme | The Hood | - | 2 pips | `hood` |
| `24012` | Field Recruitment | Treachery | The Hood | - | 1 pips | `hood` |
| `24013` | Upper Hand | Treachery | The Hood | - | 1 pips | `hood` |
| `24014` | Beast Mode | Side Scheme | Beasty Boys | - | 3 pips | `hood` |
| `24015` | Griffin | Minion | Beasty Boys | SCH:1 ATK:3 HP:7 | 2 pips | `hood` |
| `24016` | Mandrill | Minion | Beasty Boys | SCH:2 ATK:2 HP:6 | 2 pips | `hood` |
| `24017` | Double Trouble | Treachery | Beasty Boys | - | Star | `hood` |
| `24018` | Brothers Grimm | Minion | Brothers Grimm | SCH:1 ATK:1 HP:8 | 1 pips | `hood` |
| `24019` | Blackbird Pellets | Attachment | Brothers Grimm | - | - | `hood` |
| `24020` | Corrosive Egg Bomb | Attachment | Brothers Grimm | - | 1 pips | `hood` |
| `24021` | Paralytic Stardust | Attachment | Brothers Grimm | - | 2 pips | `hood` |
| `24022` | Unbreakable Thread | Attachment | Brothers Grimm | - | 3 pips | `hood` |
| `24023` | Out for Blood | Side Scheme | Crossfire's Crew | - | Star | `hood` |
| `24024` | Controller | Minion | Crossfire's Crew | SCH:2 ATK:1 HP:5 | 2 pips | `hood` |
| `24025` | Corruptor | Minion | Crossfire's Crew | SCH:1 ATK:2 HP:4 | 1 pips | `hood` |
| `24026` | Crossfire | Minion | Crossfire's Crew | SCH:2 ATK:2 HP:4 | 3 pips | `hood` |
| `24027` | Mister Fear | Minion | Crossfire's Crew | SCH:1 ATK:1 HP:5 | 1 pips | `hood` |
| `24028` | Caught in the Crossfire | Treachery | Crossfire's Crew | - | 1 pips | `hood` |
| `24029` | Cruel Intentions | Treachery | Expert II | - | 1 pips | `hood` |
| `24030` | Ruination | Treachery | Expert II | - | 4 pips | `hood` |
| `24031` | Seek and Destroy | Treachery | Expert II | - | 3 pips | `hood` |
| `24032` | Slug It Out | Treachery | Expert II | - | Star | `hood` |
| `24033` | Self-Experimentation | Side Scheme | Mister Hyde | - | 2 pips | `hood` |
| `24034` | Calvin Zabo | Minion | Mister Hyde | SCH:3 ATK:1 HP:4 | 1 pips | `hood` |
| `24035` | Mister Hyde | Minion | Mister Hyde | SCH:1 ATK:3 HP:10 | 3 pips | `hood` |
| `24036` | Hyde Formula | Treachery | Mister Hyde | - | 1 pips | `hood` |
| `24037` | Flamethrower | Attachment | Ransacked Armory | ATK:3 | 2 pips | `hood` |
| `24038` | Holoshield Generator | Attachment | Ransacked Armory | - | 1 pips | `hood` |
| `24039` | Jetpack | Attachment | Ransacked Armory | - | 1 pips | `hood` |
| `24040` | Tech Gauntlets | Attachment | Ransacked Armory | ATK:1 | 2 pips | `hood` |
| `24041` | Armored Guard | Minion | Ransacked Armory | SCH:0 ATK:1 HP:3 | 1 pips | `hood` |
| `24042` | Crime Pays | Side Scheme | Sinister Syndicate | - | 3 pips | `hood` |
| `24043` | Beetle | Minion | Sinister Syndicate | SCH:1 ATK:2 HP:4 | Star | `hood` |
| `24044` | Boomerang | Minion | Sinister Syndicate | SCH:2 ATK:1 HP:5 | 1 pips | `hood` |
| `24045` | Shocker | Minion | Sinister Syndicate | SCH:1 ATK:2 HP:5 | Star | `hood` |
| `24046` | Speed Demon | Minion | Sinister Syndicate | SCH:1 ATK:2 HP:3 | Star | `hood` |
| `24047` | White Rabbit | Minion | Sinister Syndicate | SCH:2 ATK:2 HP:3 | 1 pips | `hood` |
| `24048` | Sinister Onslaught | Treachery | Sinister Syndicate | - | - | `hood` |
...
| `24050` | Dark Dealings | Treachery | Standard II | - | 1 pips | `hood` |
| `24051` | Mob Mentality | Treachery | Standard II | - | 2 pips | `hood` |
| `24052` | Overwhelming Force | Treachery | Standard II | - | 2 pips | `hood` |
| `24053` | Shadow of the Past | Treachery | Standard II | - | 2 pips | `hood` |
| `24054` | Total Annihilation | Treachery | Standard II | - | 1 pips | `hood` |
| `24055` | Feisty Heist | Side Scheme | State of Emergency | - | 3 pips | `hood` |
| `24056` | Disaster at the Docks | Side Scheme | State of Emergency | - | 2 pips | `hood` |
| `24057` | Offshore Inferno | Side Scheme | State of Emergency | - | 2 pips | `hood` |
| `24058` | Hot Pursuit | Side Scheme | State of Emergency | - | 3 pips | `hood` |
| `24059` | Citywide Crisis | Treachery | State of Emergency | - | Star | `hood` |
| `24060` | Back-Alley Enclave | Environment | Streets of Mayhem | - | 2 pips | `hood` |
| `24061` | Secret Lair | Environment | Streets of Mayhem | - | 2 pips | `hood` |
| `24062` | Sewer Tunnels | Environment | Streets of Mayhem | - | 2 pips | `hood` |
| `24063` | Warehouse District | Environment | Streets of Mayhem | - | 2 pips | `hood` |
| `24064` | Top Talent | Side Scheme | Wrecking Crew | - | 2 pips | `hood` |
| `24065` | Wrecker | Minion | Wrecking Crew | SCH:2 ATK:2 HP:8 | 3 pips | `hood` |
| `24066` | Bulldozer | Minion | Wrecking Crew | SCH:1 ATK:3 HP:7 | 2 pips | `hood` |
| `24067` | Piledriver | Minion | Wrecking Crew | SCH:2 ATK:2 HP:6 | 2 pips | `hood` |
| `24068` | Thunderball | Minion | Wrecking Crew | SCH:3 ATK:1 HP:7 | 3 pips | `hood` |
| `24069` | Combined Effort | Treachery | Wrecking Crew | - | 1 pips | `hood` |
| `24070` | Magic Muscle | Treachery | Wrecking Crew | - | 2 pips | `hood` |
