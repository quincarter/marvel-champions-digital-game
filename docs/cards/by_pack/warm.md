...
| `23001b` | James Rhodes | Alter-Ego | War Machine | HP:10 | - | `warm` |
...
| `23028` | Equipment Malfunction | Obligation | War Machine | - | 2 pips | `warm` |
| `23029` | Living Laser | Minion | War Machine Nemesis | SCH:1 ATK:2 HP:4 | 2 pips | `warm` |
| `23030` | Deadly Light Show | Side Scheme | War Machine Nemesis | - | 3 pips | `warm` |
| `23031` | Laser Strike | Treachery | War Machine Nemesis | - | 1 pips | `warm` |
