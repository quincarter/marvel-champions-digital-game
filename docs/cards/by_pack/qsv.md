...
| `14001b` | Pietro Maximoff | Alter-Ego | Quicksilver | HP:9 | - | `qsv` |
...
| `14024` | Need for Speed | Obligation | Quicksilver | - | 2 pips | `qsv` |
| `14025` | Extortion of Seismic Proportion | Side Scheme | Quicksilver Nemesis | - | 3 pips | `qsv` |
| `14026` | Avalanche | Minion | Quicksilver Nemesis | SCH:1 ATK:2 HP:4 | 2 pips | `qsv` |
| `14027` | Vibration Resistance | Attachment | Quicksilver Nemesis | - | 1 pips | `qsv` |
| `14028` | Earthquake | Treachery | Quicksilver Nemesis | - | Star | `qsv` |
