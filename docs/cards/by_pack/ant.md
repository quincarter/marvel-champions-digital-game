...
| `12001b` | Scott Lang | Alter-Ego | Ant-Man | HP:12 | - | `ant` |
...
| `12025` | Care for Cassie | Obligation | Ant-Man | - | 2 pips | `ant` |
| `12026` | Tech Theft | Side Scheme | Ant-Man Nemesis | - | 3 pips | `ant` |
| `12027` | Yellowjacket | Minion | Ant-Man Nemesis | SCH:2 ATK:2 HP:4 | 2 pips | `ant` |
| `12028` | Size Increase | Attachment | Ant-Man Nemesis | SCH:2 ATK:2 | - | `ant` |
| `12029` | Yellowjacket's Plan | Treachery | Ant-Man Nemesis | - | 1 pips | `ant` |
