...
| `46001b` | Bobby Drake | Alter-Ego | Iceman | HP:11 | - | `iceman` |
...
| `46024` | Hot-Headed | Obligation | Iceman | - | 2 pips | `iceman` |
| `46025` | Pyro | Minion | Iceman Nemesis | SCH:1 ATK:3 HP:4 | 3 pips | `iceman` |
| `46026` | Playing with Fire | Side Scheme | Iceman Nemesis | - | 3 pips | `iceman` |
| `46027` | Pyro's Flamethrower | Attachment | Iceman Nemesis | ATK:0 | 2 pips | `iceman` |
| `46028` | Burn! | Treachery | Iceman Nemesis | - | Star | `iceman` |
| `46029` | Sauron | Minion | Sauron | SCH:2 ATK:2 HP:6 | Star | `iceman` |
| `46030` | Sauron Lives! | Side Scheme | Sauron | - | 3 pips | `iceman` |
| `46031` | Life Drain | Attachment | Sauron | - | 2 pips | `iceman` |
| `46032` | The Eye of Sauron | Treachery | Sauron | - | 1 pips | `iceman` |
