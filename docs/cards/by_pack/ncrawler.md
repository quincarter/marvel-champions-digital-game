...
| `48001b` | Kurt Wagner | Alter-Ego | Nightcrawler | HP:9 | - | `ncrawler` |
...
| `48026` | Crisis of Faith | Obligation | Nightcrawler | - | 2 pips | `ncrawler` |
| `48027` | Azazel | Minion | Nightcrawler Nemesis | SCH:2 ATK:3 HP:3 | Star | `ncrawler` |
| `48028` | Brimstone Dimension | Side Scheme | Nightcrawler Nemesis | - | 3 pips | `ncrawler` |
| `48029` | Azazel's Sword | Attachment | Nightcrawler Nemesis | ATK:1 | 2 pips | `ncrawler` |
| `48030` | Brimstone Strike | Treachery | Nightcrawler Nemesis | - | 1 pips | `ncrawler` |
| `48031` | Combine Forces | Event | Pack Position: 31 | - | - | `ncrawler` |
| `48032` | Gunboat Diplomacy | Event | Pack Position: 32 | - | - | `ncrawler` |
| `48033` | The Crazy Gang | Side Scheme | Crazy Gang | - | 2 pips | `ncrawler` |
| `48034` | Queen of Hearts | Minion | Crazy Gang | SCH:0 ATK:1 HP:4 | 3 pips | `ncrawler` |
| `48035` | Jester | Minion | Crazy Gang | SCH:0 ATK:1 HP:5 | 1 pips | `ncrawler` |
| `48036` | Executioner | Minion | Crazy Gang | SCH:0 ATK:2 HP:4 | 2 pips | `ncrawler` |
| `48037` | Tweedledope | Minion | Crazy Gang | SCH:0 ATK:2 HP:6 | 1 pips | `ncrawler` |
| `48038` | "Off with His Head!" | Treachery | Crazy Gang | - | 1 pips | `ncrawler` |
