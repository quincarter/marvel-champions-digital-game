...
| `37001b` | Remy LeBeau | Alter-Ego | Gambit | HP:9 | - | `gambit` |
...
| `37025` | Guild Business | Obligation | Gambit | - | 2 pips | `gambit` |
| `37026` | Belladonna | Minion | Gambit Nemesis | SCH:2 ATK:3 HP:5 | 3 pips | `gambit` |
| `37027` | The Assassins Guild | Side Scheme | Gambit Nemesis | - | 3 pips | `gambit` |
| `37028` | Guild Assassin | Minion | Gambit Nemesis | SCH:1 ATK:2 HP:2 | 2 pips | `gambit` |
| `37029` | Assassination Attempt | Treachery | Gambit Nemesis | - | 1 pips | `gambit` |
| `37030` | War Room | Support | Pack Position: 30 | - | - | `gambit` |
| `37031` | X-Men Instruction | Event | Pack Position: 31 | - | - | `gambit` |
| `37032` | Exodus | Minion | Exodus | SCH:1 ATK:1 HP:6 | 3 pips | `gambit` |
| `37033` | Herald of Avalon | Side Scheme | Exodus | - | 3 pips | `gambit` |
| `37034` | Psionic Shield | Attachment | Exodus | SCH:1 ATK:1 | 2 pips | `gambit` |
| `37035` | Acolyte Frenzy | Treachery | Exodus | - | Star | `gambit` |
