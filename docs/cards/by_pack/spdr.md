...
| `31025` | Inherited Burden | Obligation | SP//dr | - | 2 pips | `spdr` |
| `31026` | Giant Monster Attack | Side Scheme | SP//dr Nemesis | - | 3 pips | `spdr` |
| `31027` | M.O.R.B.I.U.S. | Minion | SP//dr Nemesis | SCH:2 ATK:2 HP:6 | 2 pips | `spdr` |
| `31028` | Energy Drain | Treachery | SP//dr Nemesis | - | 1 pips | `spdr` |
| `31029` | Clarity of Purpose | Upgrade | Pack Position: 29 | - | - | `spdr` |
| `31030` | Grand Larceny | Side Scheme | Iron Spider's Sinister Six | - | 3 pips | `spdr` |
| `31031` | Bombshell | Minion | Iron Spider's Sinister Six | SCH:2 ATK:3 HP:4 | Star | `spdr` |
| `31032` | Electro | Minion | Iron Spider's Sinister Six | SCH:1 ATK:2 HP:3 | 1 pips | `spdr` |
| `31033` | Hobgoblin | Minion | Iron Spider's Sinister Six | SCH:2 ATK:2 HP:5 | 2 pips | `spdr` |
| `31034` | Iron Spider | Minion | Iron Spider's Sinister Six | SCH:2 ATK:2 HP:6 | 3 pips | `spdr` |
| `31035` | Sandman | Minion | Iron Spider's Sinister Six | SCH:1 ATK:1 HP:7 | 1 pips | `spdr` |
| `31036` | Spot | Minion | Iron Spider's Sinister Six | SCH:1 ATK:1 HP:4 | Star | `spdr` |
| `31037` | Surge in Crime | Environment | Iron Spider's Sinister Six | - | 2 pips | `spdr` |
