...
|---|---|---|---|---|---|---|
| `57001` | She-Hulk | Leader | She-Hulk | SCH:1 ATK:2 HP:16 | - | `synthezoid` |
| `57002` | She-Hulk | Leader | She-Hulk | SCH:1 ATK:3 HP:20 | - | `synthezoid` |
| `57003` | She-Hulk | Leader | She-Hulk | SCH:1 ATK:3 HP:20 | - | `synthezoid` |
| `57004` | She-Hulk | Leader | She-Hulk | SCH:2 ATK:3 HP:24 | - | `synthezoid` |
...
| `57007` | Superhuman Strength | Attachment | She-Hulk | ATK:2 | Star | `synthezoid` |
| `57008` | Focused Rage | Attachment | She-Hulk | SCH:1 | Star | `synthezoid` |
| `57009` | One-Two Punch | Treachery | She-Hulk | - | 2 pips | `synthezoid` |
| `57010` | Ground Stomp | Treachery | She-Hulk | - | Star | `synthezoid` |
| `57011` | Gamma Slam | Treachery | She-Hulk | - | 3 pips | `synthezoid` |
| `57012` | Legal Practice | Side Scheme | She-Hulk | - | 3 pips | `synthezoid` |
| `57013` | S.H.I.E.L.D. Operator | Minion | S.H.I.E.L.D. Ops | SCH:2 ATK:2 HP:3 | 2 pips | `synthezoid` |
| `57014` | Strategic Overwatch | Treachery | S.H.I.E.L.D. Ops | - | Star | `synthezoid` |
| `57015` | Rapid Response | Treachery | S.H.I.E.L.D. Ops | - | 1 pips | `synthezoid` |
| `57016` | Homeland Security | Side Scheme | S.H.I.E.L.D. Ops | - | 3 pips | `synthezoid` |
| `57017` | Atlas | Minion | Thunderbolts | SCH:1 ATK:2 HP:4 | Star | `synthezoid` |
| `57018` | Songbird | Minion | Thunderbolts | SCH:2 ATK:1 HP:3 | Star | `synthezoid` |
| `57019` | Penance | Minion | Thunderbolts | SCH:2 ATK:2 HP:4 | Star | `synthezoid` |
| `57020` | Justice Like Lightning | Treachery | Thunderbolts | - | 1 pips | `synthezoid` |
| `57021` | The Thunderbolts | Side Scheme | Thunderbolts | - | 2 pips | `synthezoid` |
| `57022` | Taskmaster | Minion | Taskmaster | SCH:1 ATK:1 HP:6 | 3 pips | `synthezoid` |
| `57023` | Taskmaster's Sword | Attachment | Taskmaster | ATK:1 | 1 pips | `synthezoid` |
| `57024` | Taskmaster's Shield | Attachment | Taskmaster | SCH:1 | 1 pips | `synthezoid` |
| `57025` | Mimicked Move | Treachery | Taskmaster | - | 1 pips | `synthezoid` |
| `57026` | Taskmaster's Academy | Side Scheme | Taskmaster | - | 2 pips | `synthezoid` |
| `57027` | Jester | Minion | Deadly Duo | SCH:1 ATK:2 HP:3 | 2 pips | `synthezoid` |
| `57028` | Jack O'Lantern | Minion | Deadly Duo | SCH:2 ATK:1 HP:3 | 2 pips | `synthezoid` |
| `57029` | Mad Jack's Platform | Attachment | Deadly Duo | SCH:1 ATK:1 | Star | `synthezoid` |
| `57030` | Jester's Yo-Yo | Treachery | Deadly Duo | - | Star | `synthezoid` |
| `57031` | Deadly Duo | Side Scheme | Deadly Duo | - | 2 pips | `synthezoid` |
...
| `57036` | Righteous Cause | Treachery | Standard PVP | - | - | `synthezoid` |
| `57037` | Whatever It Takes | Treachery | Standard PVP | - | - | `synthezoid` |
| `57038` | Targeted Strike | Treachery | Standard PVP | - | Star | `synthezoid` |
| `57039a` | Choosing Sides | Side Scheme | Standard PVP | - | - | `synthezoid` |
| `57039b` | Now It's Personal | Obligation | Standard PVP | - | - | `synthezoid` |
| `57040` | Vision | Leader | Vision | SCH:1 ATK:1 HP:14 | - | `synthezoid` |
| `57041` | Vision | Leader | Vision | SCH:1 ATK:2 HP:18 | - | `synthezoid` |
| `57042` | Vision | Leader | Vision | SCH:1 ATK:2 HP:18 | - | `synthezoid` |
| `57043` | Vision | Leader | Vision | SCH:2 ATK:2 HP:22 | - | `synthezoid` |
...
| `57046a` | Dense | Attachment | Vision | ATK:1 | - | `synthezoid` |
| `57046b` | Intangible | Attachment | Vision | SCH:1 | - | `synthezoid` |
| `57047` | Solar Gem | Attachment | Vision | SCH:1 | Star | `synthezoid` |
| `57048` | Vision's Cape | Attachment | Vision | ATK:1 | Star | `synthezoid` |
| `57049` | Mass Increase | Attachment | Vision | - | 2 pips | `synthezoid` |
| `57050` | Density Control | Attachment | Vision | - | 3 pips | `synthezoid` |
| `57051` | Solar Beam | Treachery | Vision | - | 1 pips | `synthezoid` |
| `57052` | Superdense Strike | Treachery | Vision | - | 2 pips | `synthezoid` |
| `57053` | Phase Disruption | Treachery | Vision | - | 2 pips | `synthezoid` |
| `57054` | Just Passing Through | Side Scheme | Vision | - | 3 pips | `synthezoid` |
| `57055` | Patriot | Minion | Young Avengers | SCH:2 ATK:2 HP:4 | 1 pips | `synthezoid` |
| `57056` | Hawkeye | Minion | Young Avengers | SCH:2 ATK:2 HP:3 | 1 pips | `synthezoid` |
| `57057` | Stature | Minion | Young Avengers | SCH:1 ATK:2 HP:5 | 1 pips | `synthezoid` |
| `57058` | Teenage Superheroes | Treachery | Young Avengers | - | 2 pips | `synthezoid` |
| `57059` | Young Avengers | Side Scheme | Young Avengers | - | 2 pips | `synthezoid` |
| `57060` | Speed | Minion | Scarlet Twins | SCH:1 ATK:2 HP:3 | 2 pips | `synthezoid` |
| `57061` | Wiccan | Minion | Scarlet Twins | SCH:2 ATK:1 HP:3 | 2 pips | `synthezoid` |
| `57062` | Superspeed | Treachery | Scarlet Twins | - | Star | `synthezoid` |
| `57063` | Spellcasting | Obligation | Scarlet Twins | - | 1 pips | `synthezoid` |
| `57064` | Superpowered Siblings | Side Scheme | Scarlet Twins | - | 2 pips | `synthezoid` |
| `57065` | Moon Knight | Minion | Moon Knight | SCH:2 ATK:2 HP:5 | 2 pips | `synthezoid` |
| `57066` | Crescent Dart | Attachment | Moon Knight | ATK:2 | 1 pips | `synthezoid` |
| `57067` | Fist of Khonshu | Treachery | Moon Knight | - | Star | `synthezoid` |
| `57068` | Khonshu's Avatar | Side Scheme | Moon Knight | - | 2 pips | `synthezoid` |
| `57069` | Janus | Minion | Royal Guard | SCH:1 ATK:3 HP:3 | 2 pips | `synthezoid` |
| `57070` | Amir | Minion | Royal Guard | SCH:2 ATK:2 HP:3 | 2 pips | `synthezoid` |
| `57071` | Atlanteans | Treachery | Royal Guard | - | 2 pips | `synthezoid` |
| `57072` | Blood Debt | Obligation | Royal Guard | - | 1 pips | `synthezoid` |
| `57073` | The Royal Guard | Side Scheme | Royal Guard | - | 2 pips | `synthezoid` |
...
| `57078` | Righteous Cause | Treachery | Standard PVP | - | - | `synthezoid` |
| `57079` | Whatever It Takes | Treachery | Standard PVP | - | - | `synthezoid` |
| `57080` | Targeted Strike | Treachery | Standard PVP | - | Star | `synthezoid` |
| `57081a` | Choosing Sides | Side Scheme | Standard PVP | - | - | `synthezoid` |
| `57081b` | Now It's Personal | Obligation | Standard PVP | - | - | `synthezoid` |
