...
| `09001b` | Stephen Strange | Alter-Ego | Doctor Strange | HP:10 | - | `drs` |
...
| `09027` | Physical Toll | Obligation | Doctor Strange | - | 2 pips | `drs` |
| `09028` | Baron Mordo | Minion | Doctor Strange Nemesis | SCH:2 ATK:2 HP:5 | 2 pips | `drs` |
| `09029` | Open the Dark Dimension | Side Scheme | Doctor Strange Nemesis | - | 3 pips | `drs` |
| `09030` | Counterspell | Attachment | Doctor Strange Nemesis | - | 1 pips | `drs` |
| `09031` | Thoughtcasting | Treachery | Doctor Strange Nemesis | - | 1 pips | `drs` |
