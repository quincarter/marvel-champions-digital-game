...
| Galactic Artifacts modular set (16122–16130)                                                                                                                                                                                                                                               | **Not started** (needed by Infiltrate the Museum/Escape the Museum, not Nebula or Ronan)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Kree Militants modular set (16131–16134)                                                                                                                                                                                                                                                   | **Not started** — 16131.kree-combat-armor-action ("Spend 3 resources of the same type →") is a likely genuine gap: no `ResourceRequirement` shape expresses "the player's choice of type, but all N must match" (flag for whoever scripts Ronan the Accuser to confirm and skip if still true).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
**Next session on `gmw` should do Ronan the Accuser** (16102–16121 + Kree Militants modular, 16131–16134) —
Power Stone (16149) is already scripted (Nebula landed it); Galactic Artifacts (16122–16130, needed by Infiltrate
the Museum/Escape the Museum, not Ronan) still isn't reached by any scenario. Menagerie Medley (16135–16137) is
fully scripted (`gmw/museum.ts`) and Ship Command (16142–16148) is fully scripted (`gmw/ship-command.ts`); both are
shared by Escape the Museum. `MC_REFS_PACKS=gmw pnpm refs` is the up-to-date source of truth for exactly which refs
remain — the table above is a snapshot, that command is not.
