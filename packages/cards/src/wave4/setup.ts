import { CORE_STARTER_DECKS, NEBU_STARTER_DECKS, WARM_STARTER_DECKS, type CardId } from "@mc/content";
...
/** A wave 4 (currently: Nebula, War Machine) or Core starter deck as a player seat (quantities expanded). */
