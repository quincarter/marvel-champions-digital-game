 ...
 */
import { NEBU_CARDS, PLAYABLE_CARDS, WARM_CARDS, type AnyCard } from "@mc/content";

/** Every playable card through wave 3, plus Nebula and War Machine. */
export const WAVE4_CARDS: readonly AnyCard[] = [...PLAYABLE_CARDS, ...NEBU_CARDS, ...WARM_CARDS];
