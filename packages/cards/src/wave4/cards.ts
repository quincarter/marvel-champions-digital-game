 ...
 */
import { NEBU_CARDS, PLAYABLE_CARDS, VALK_CARDS, WARM_CARDS, type AnyCard } from "@mc/content";

/** Every playable card through wave 3, plus Nebula, War Machine and Valkyrie. */
export const WAVE4_CARDS: readonly AnyCard[] = [...PLAYABLE_CARDS, ...NEBU_CARDS, ...WARM_CARDS, ...VALK_CARDS];
