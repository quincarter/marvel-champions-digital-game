 ...
 * heroes now scripted), the Tower Defense scenario (`tower-defense.ts`), then the box's remaining
 * scenarios/modulars/campaign in a later pass (§3, step 3 — see `KNOWN_SKIPPED.mts` in `../coverage.test.ts`).
 */
