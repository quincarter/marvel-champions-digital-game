import { after, boost, defineAbilities, discard, forcedResponse, giveBoostCard, heal, heroAction, ifThen, made, modifyAttack, not, scaled, self, spend, spendResources, surge, theVillain, varAtLeast, whenRevealed, you } from "../../dsl/index.js";
...
export const GOBLIN_GIMMICKS = defineAbilities({
  ...
  "02035.when-revealed": whenRevealed(spendResources({ generic: 2 }, "spent"), ifThen(not(made("spent")), giveBoostCard())),
