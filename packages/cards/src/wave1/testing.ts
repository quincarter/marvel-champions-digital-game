 ...
 * `stackEncounterDeck`, `payWith`, `picking`, `firstLegal`, all unaffected by which content is loaded), never
 * edits it. See docs/phase7-wave1-scripting.md "Test conventions".
 */
