/**
 * C08 — placeholder until this screen is built. Registered so every route in `routes.ts` already resolves.
 */
...
export class CampaignBriefingScene extends Phaser.Scene {
  ...
  create(_data: CampaignBriefingData): void {
    this.cameras.main.setBackgroundColor(cssOf(surface.paper.hex));
    drawTopBar(this, { backLabel: "◂ Title", onBack: () => goToScreen(this, SCENES.title), title: "Briefing" });
    fadeScreenIn(this);
  }
}
