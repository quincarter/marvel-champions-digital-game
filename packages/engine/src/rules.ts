...
export const threatCannotBeRemoved = (state: GameState, deps: EngineDeps, schemeId: InstanceId): boolean =>
  activeRules(state, deps, "threatCannotBeRemoved").some(({ rule, context }) =>
