...
export const BKW_CURATION: PackCuration = {
  ...
  pack: {
    ...
    releaseDateSource: "Hall of Heroes Black Widow page (https://hallofheroeslcg.com/natasha-romanoff-black-widow/): \"Release date: June 5, 2020 (originally April 3, 2020)\"",
  },
  outDir: "src/data/bkw",
  exportPrefix: "BKW",
  ...
  errata: [
    {
      ...
      evidence: "RRG p.66 errata (\"Changed 'trigger' to 'resolve'.\"); ruling Feb 28 (2) (\"Both Black Widow and Synth-Suit should say 'resolve'.\"); MarvelCDB carries no `errata` field for this card and its text still reads \"trigger\" (verified as the un-updated print, not a second wording)",
  ...
  scriptingNotes: {},
  cardNotes: {
    "08026": "Taskmaster's printed ATK/SCH are 0★ (the ★ is a reminder that both are boosted by this card's own Boost ability, not a printed non-zero value). raw attack=0/scheme=0, not absent [evidence: raw; phase7 §1.12].",
    "08028": "Guard minion (Hydra Mercenary). Printed SCH is 0 (not \"—\"): raw scheme=0, not absent [evidence: raw; phase7 §1.12].",
  },
  ...
  starterDecks: [
    {
      ...
      aspect: "justice",
      cards: {
        "08002": 1, "08003": 2, "08004": 2, "08005": 1, "08006": 2, "08007": 2, "08008": 2, "08009": 1, "08010": 2,
        "08011": 1, "08012": 1, "08013": 3, "08014": 2, "08015": 2, "08016": 2, "08017": 3, "08018": 3,
        "08019": 1, "08020": 1, "08021": 1, "08022": 1, "08023": 1, "08024": 3,
      },
