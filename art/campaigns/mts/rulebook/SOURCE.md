# Official rulebook comic pages

Rendered from `docs/campaign-modes/mc21_the_mad_titans_shadow_rulebook-compressed.pdf` by the `extract-artboards` skill
(`.claude/skills/extract-artboards/`), at 300 dpi, then saved as JPEG (1800 px long side, quality 82).
